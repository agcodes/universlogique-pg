"use strict"
define("universlogique-pg/app",["exports","@ember/application","ember-resolver","ember-load-initializers","universlogique-pg/config/environment"],(function(e,t,i,n,s){function a(e,t,i){return(t=function(e){var t=function(e,t){if("object"!=typeof e||null===e)return e
...
n=self}var s,a=i.default.exportApplicationGlobal
s="string"==typeof a?a:t.default.String.classify(i.default.modulePrefix),n[s]||(n[s]=e,e.reopen({willDestroy:function(){this._super.apply(this,arguments),delete n[s]}}))}}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0,e.initialize=n
var s={name:"export-application-global",initialize:n}
e.default=s})),define("universlogique-pg/instance-initializers/head-browser",["exports"],(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
const s=new ArrayBuffer(e.data.length)
this.buf8=new Uint8ClampedArray(s),this.data=new Uint32Array(s),this.data[1]=168496141,this.isLittleEndian=!0,10===s[4]&&11===s[5]&&12===s[6]&&13===s[7]&&(this.isLittleEndian=!1)}addBackgroundInImageData(e){if(null===e)return!1
...
return!0}addBackgroundInDrawingArea(e,t,i,n,s){for(let a=s;a<i;a++)for(let i=n;i<t;i++)this.addOnePointInData([i,a],e,1)}addOnePointInData(e,t,i){if(null===t)return!1
let n=Math.floor(e[0]),s=Math.floor(e[1])
i>1&&(2===i?(n-=1,s-=1):i%2==0?(n-=i/2,s-=i/2):(n-=(i-1)/2,s-=(i-1)/2))
for(let a=0;a<i;a++){for(let e=0;e<i;e++){if(n<0)return!1
if(s<0)return!1
if(n+1>this.w)return!1
if(s+1>this.h)return!1
const e=s*this.w+n
e>=0&&e<=this.data.length&&(("number"!=typeof t[3]||t[3]===1/0||t[3]>255)&&(t[3]=255),!0===this.isLittleEndian?this.data[e]=Math.round(t[3])<<24|Math.round(t[2])<<16|Math.round(t[1])<<8|Math.round(t[0]):this.data[e]=Math.round(t[0])<<24|Math.round(t[1])<<16|Math.round(t[2])<<8|Math.round(t[3])),n++}s++}return!0}}})),define("universlogique-pg/object/math/CComplex",["exports"],(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
t.i++}return!0}requestAnimationFrame_(e){try{return window.requestAnimationFrame(e)||window.mozRequestAnimationFrame(e)||window.webkitRequestAnimationFrame||window.oRequestAnimationFrame(e)||window.msRequestAnimationFrame(e)||null}catch(t){return-1}}animateWithTimeOut(e,t,i,n,s){return"function"==typeof e&&(t.animationParams.f=e,t.animationParams.t=i,t.animationParams.params=n,t.animationParams.id_=s,window.that=t),!0===window.that.getAnimationRunning()&&(!1===window.that.functions[window.that.animationParams.f](window.that.animationParams.params)?(window.that.stopAnimationRunning(!0),!1):(window.that.animationParams.params.i++,void setTimeout(window.that.animateWithTimeOut,window.that.animationParams.t)))}testRafSupport(){let e=null
...
throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string")
return"symbol"==typeof t?t:String(t)}(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default=class{constructor(){i(this,"canvasData",null),i(this,"imageData",null),i(this,"offSet",null),i(this,"limitWidth",0),i(this,"limitHeight",0),i(this,"centerAbs",!0),i(this,"margin",null),i(this,"grad",null),i(this,"ptMin",null),i(this,"ptMax",null)}setContext(e){if(this.canvasElement=document.getElementById(e),this.context=null,this.offSet=[0,0,0],this.canvasElement)return this.context=this.canvasElement.getContext("2d"),!this.context}initialize(){this.ptMax=[this.width,this.height,0],this.ptMin=[0,0,0],this.margin=[0,0,0],this.offSet=[0,0,0],this.grad=[1,1,1],this.paramsDefined=!1,this.signedCoord=!1}setCanvasData(e,i,n,s){this.width=e,this.height=i,this.limitWidth=e,this.limitHeight=i,this.imagedata=this.context.createImageData(e,i),this.canvasData=new t.default,this.canvasData.initialize(this.imagedata,e,i,[n,s]),this.canvasData.getImageData(this.imagedata)}addBackgroundInImageData(e){return null!==e&&this.canvasData.addBackgroundInImageData(e)}addPointsInData(e,t,i){return null!==e&&0!==e.length&&(null!==this.canvasData&&(void 0===i&&(i=1),this.canvasData.addPointsInData(e,t,i)))}updateImageData(e,t,i){return null!==e&&(null!==this.canvasData&&(this.canvasData.addPointsInData(e,t,i),this.putImageData(0,0)))}putImageData(e,t,i,n){return this.canvasData.getImageData(this.imagedata),!(e>this.imagedata.width)&&(!(t>this.imagedata.height)&&("number"!=typeof i?this.context.putImageData(this.imagedata,e,t):(i-e>this.imagedata.width&&(i=this.imagedata.width-e),n-t>this.imagedata.height&&(n=this.imagedata.height-t),this.context.putImageData(this.imagedata,e,t,e,t,i,n)),!0))}defGrid(e,t,i,n){null!==n&&"object"==typeof n||(n=[0,0,0])
...
for(let i=0,n=e.length;i<n;i++)if(this.isSet(e[i]))for(let s=0;s<3;s++)this.isSet(e[i][s])&&(0===i||e[i][s]<t[s])&&isFinite(e[i][s])&&(t[s]=e[i][s])
return t}getMaxOfPts(e,t){let i=[0,0,0,null]
if(!1===t){for(let n=0,s=e.length;n<s;n++)if(this.isSet(e[n]))for(let t=0;t<3;t++)this.isSet(e[n][t])&&isFinite(e[n][t])&&(0===n||e[n][t]>i[t])&&(i[t]=e[n][t])}else for(let n=0,s=e.length;n<s;n++)if(this.isSet(e[n]))for(let t=0;t<3;t++)this.isSet(e[n][t])&&isFinite(e[n][t])&&(0===n||Math.abs(e[n][t])>i[t])&&(i[t]=Math.abs(e[n][t]))
return i}getPointFromPlan(e,t,i){if("number"!=typeof i&&(i=6),!1===this.isSet(e))return e
if(t&&(e[0]-=this.limitX0),0===this.grad[0]&&0===this.grad[1])return e
const n=this.centerAbs?(e[0]-(this.limitWidth-this.limitHeight)/2-this.margin[0]+this.ptMin[0]*this.grad[0])/this.grad[0]-this.offSet[1]*this.grad[1]:(e[0]-this.margin[0]+this.ptMin[0]*this.grad[0])/this.grad[0]-this.offSet[1]*this.grad[1],s=(e[1]-this.margin[1]+this.ptMin[1]*this.grad[1])/this.grad[1]-this.offSet[0]*this.grad[0],a=Math.pow(10,i)
return[Math.round(n*a)/a,Math.round(s*a)/a,0,void 0!==e[3]?e[3]:null]}getPointOnPlan(e){let t=0,i=0,n=0,s=null
return!1===this.isSet(e)?e:("object"==typeof e[3]&&(s=e[3]),0===this.grad[0]&&0===this.grad[1]?e:(t=(e[0]-this.ptMin[0])*this.grad[0]+this.margin[0],i=(e[1]-this.ptMin[1])*this.grad[1]+this.margin[1],n=0,void 0!==e[4]?[Math.round(t+this.offSet[0]*this.grad[0]),Math.round(i+this.offSet[1]*this.grad[1]),0,s,e[4]]:[Math.round(t+this.offSet[0]*this.grad[0]),Math.round(i+this.offSet[1]*this.grad[1]),0,s]))}isSet(e){return null!=e}}})),define("universlogique-pg/services/colors-service",["exports"],(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
const t=e[0]/255,i=e[1]/255,n=e[2]/255,s=Math.max(t,i,n),a=Math.min(t,i,n)
let r=(s+a)/2,o=0
const u=(s+a)/2
if(s===a)r=0
else{const e=s-a
switch(o=u>.5?e/(2-s-a):e/(s+a),s){case t:r=(i-n)/e+(i<n?6:0)
break
case i:r=(n-t)/e+2
break
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("universlogique-pg/app").default.create({name:"universlogique-pg",version:"5.0.0+9f6fb90d"})
