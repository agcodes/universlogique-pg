...
define("ember-engines/test-support/engine-resolver-for", ["exports", "ember-resolver", "@ember/debug"], function (_exports, _emberResolver, _debug) {
  ...
  function engineResolverFor(engineName) {
    let modulePrefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : engineName;
    let podModulePrefix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
...
define("ember-engines/test-support/index", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";
